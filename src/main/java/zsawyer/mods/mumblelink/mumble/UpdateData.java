...
public class UpdateData {
    ...
    public void set(Minecraft game) {
        try {
            ...
            fAvatarPosition = new float[]{
                    (float) game.player.getEyePosition().x,
                    (float) game.player.getEyePosition().z,
                    (float) game.player.getEyePosition().y
            };
    ...
    private Vector3d getTopVec(Minecraft game) {
        double f1 = Math.cos(-game.player.getRotationVector().y* 0.017453292F
                - (float) Math.PI);
        double f2 = Math.sin(-game.player.getRotationVector().y * 0.017453292F
                - (float) Math.PI);
        double f3 = -Math
                .cos((-game.player.getRotationVector().x + 90) * 0.017453292F);
        double f4 = Math
                .sin((-game.player.getRotationVector().x + 90) * 0.017453292F);
